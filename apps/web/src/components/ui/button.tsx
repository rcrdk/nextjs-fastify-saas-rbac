	...
	'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 select-none',
	{
		variants: {
			variant: {
				...
				warning:
					'bg-amber-600 dark:bg-amber-400 text-primary-foreground hover:bg-primary/90 hover:bg-amber-700 dark:hover:bg-amber-500',
				ghostWarning:
					'hover:bg-amber-600/15 hover:text-amber-600 dark:hover:bg-amber-400/30 dark:hover:text-amber-400',
			},
			size: {
				...
				icon: 'h-10 w-10',
				iconInput: 'absolute bottom-1 right-1 size-8',
			},
		},
		defaultVariants: {
			variant: 'default',
